...
<head>
	...
	<meta name="author" content="" />
		...
		<!--[if lt IE 9]>
			<script nonce="<@wp.cspNonce />" src="<@wp.resourceURL />static/js/entando-misc-html5-essentials/html5shiv.js"></script>
		<![endif]-->
...
INSERT INTO pagemodels (code,descr,frames,plugincode,templategui) VALUES ('jpgeoref_home','Home Page for test georef Content','<frames>
	<frame pos="0">
		<descr>Test frame</descr>
	</frame>
</frames>','jpgeoref',NULL);
