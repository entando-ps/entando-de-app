...
<@wp.outputHeadInfo type="JS">
	<script nonce="<@wp.cspNonce />" src="<@wp.resourceURL />static/js/<@wp.printHeadInfo />"></script>
</@wp.outputHeadInfo>

<#-- external/CDN js scripts (remember to include the libraries first) -->
<@wp.outputHeadInfo type="JS_EXT">
	<script nonce="<@wp.cspNonce />" src="<@wp.printHeadInfo />"></script>
</@wp.outputHeadInfo>
...
<script nonce="<@wp.cspNonce />" src="<@wp.resourceURL />static/js/entando-misc-less/less-1.3.1.min.js"></script>',NULL,0);
...
<form class="form-horizontal jpwebdynamicform-<@s.property value="#typeCodeKey" />" action="<@wp.action path="/ExtStr2/do/jpwebdynamicform/Message/User/send.action"/>" method="post">
	...
	<@s.if test="recaptchaEnabled">
		<script nonce="<@wp.cspNonce />" type="text/javascript" src="http://api.recaptcha.net/challenge?k=<@wp.info key="systemParam" paramName="jpwebdynamicform_recaptcha_publickey" />"></script>
		<noscript>
