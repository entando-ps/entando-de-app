...
export CATALINA_OPTS="$CATALINA_OPTS ${XMS:=-Xms3g}"
export CATALINA_OPTS="$CATALINA_OPTS ${XMX:=-Xmx3g}"
export CATALINA_OPTS="$CATALINA_OPTS -XX:+UseG1GC"
export CATALINA_OPTS="$CATALINA_OPTS ${INITIAL_HEAP_SIZE:=-XX:InitialHeapSize=3g}"
export CATALINA_OPTS="$CATALINA_OPTS ${MAX_HEAP_SIZE:=-XX:MaxHeapSize=3g}"
